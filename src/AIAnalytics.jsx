...
function AIAnalytics() {
  ...
  const service = {
    ...
    tagline: "Stop guessing and start knowing. Transform raw data into strategic foresight with AI-powered intelligence and real-time visualization.",
    ...
    longDescription: "Turning Complex Data into Clear, Actionable Strategy. Our AI-powered analytics platform empowers you to make data-driven decisions with confidence. From executive dashboards to predictive forecasting, we provide the tools and insights needed to stay ahead in today's competitive landscape.",
    features: [
    ...
    benefits: [
      ...
      "Unify data from multiple sources into one truth",
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        >
          <h2 className="text-3xl font-bold text-gray-900 mb-6 relative">
            Turning Complex Data into Clear, Actionable Strategy
        ...
        >
          <div className="max-w-3xl mx-auto bg-white rounded-3xl shadow-xl p-10 border border-gray-200">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Ready to Transform Your Data into Strategy?
            </h2>
